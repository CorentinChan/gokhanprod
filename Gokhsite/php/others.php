...
<body>
    ...
    <main>
        ...
        <div class = "mainFontBlue">
            <p><em> J'èspere que le site vous a plu , si vous en voulez encore il reste encore quelques rubriques comme mes prints 3d que j'ai modélisé, mes compositions de guitare que j'ai mixé sur abletonlive, et des jeux online que j'ai fait en javascript, enjoy!
                ...
                <div class="image-container2">
                    ...
                    <a href="3dprints.php" class="full-link">  <center><img class="resize-image2"  src="../imgboard/3dviewescshield.jpg"> 
                        <p>3D Prints</p> </center> </a>
    
                        <a href="sounds.php" class="full-link">  <center><img class="resize-image2"  src="../img/soundsimage.png"> 
                          <p>Gokhan Sounds</p> </center> </a>
            
                        <a href="games.php" class="full-link">  <center><img class="resize-image2"  src="../img/imgliengame.png"> 
                        <p>Online Games</p> </center> </a>
